...
<!--
世界はプログラマブルになってきているが、人はまだプログラマブルではない。
本論文では、人をプログラマブルにするための技術について報告する
-->


<!--人がコンピュータの支援を受けるだけではなく、コンピュータには難しい処理を積極的におこない、目的達成のために相補的に動いていく-->
...
-->
<!--
実世界におけるあらゆる処理をプログラムで制御するための技術が進化し続けている。
ユビキタスコンピューティングや実世界指向インタフェース等の研究によって、実世界にある様々なものがプログラムから制御可能になる。
プログラムからの制御によって物理構造そのものを変化させる仕組みなどの研究も存在している。
また、商品レベルでも、Phillips社のプログラマブル電球Hue などが発売されており、プログラマブルな実世界構成要素が実際の生活の中にも広がっている。
プログラムが制御可能な実世界の領域は今後も広がっていくと考えられる。

あらゆる処理がプログラムによって実現するようになっていくと、その仕組みを利用しようとする人間との連携が重要となってくる。
しかし、人間はプログラムによって制御することができていないため、プログラムを最大限に活用することができない。

ここに、一文つなぐのを入れたい

人間がプログラムから利用可能になることで、コンピュータやセンサー、アクチュエータと同等の処理ノードとなる。
人間が関係するあらゆる処理をプログラムで記述することが可能になる
コンピュータが得意なことはコンピュータが、人は人のほうが得意なことや人がやらなくてはならない処理を行う、といったことを明確に分けて記述することができるようになる。

そこで、本論文ではBabascriptという、人に対してプログラム上から処理命令を送り、処理に対する返り値の受信を実現する一連のシステムを提案する。

-->

<!--人にAPI生やして実世界のどこでもプログラムからいじれるようにしたらプログラムで処理できることが増えるからBabascript提案する。不特定多数の人を相手にしたクラウドソーシングじゃなくて身近な人を対象にしてる仕組みだから勘違いするなよ-->

<!--

- 人にはAPIがなくてプログラムからアクセスできない

-->

<!--

- プログラムはコンピュータを動かすものであり、人を支援するもの
    - 人そのものは管理できていない
- 
...
世界がプログラムで記述できるようになっていく中で、人への命令をプログラムで記述できるような取り組みは少なく、その用途も限定的なものが多い。

現在の技術では、プログラムによってコンピュータを動かし、人を支援するだけであり、プログラムは人を効率的に動かしたりすることはできない。
コンピュータにやらせたいことを記述するだけであり、
人をもプログラムの対象にすることで、人とコンピュータを、タスクを処理する上で最適な組み合わせで動かすことが実現する。
つまり、人もコンピュータもプログラム上において、目的を達成するために使うことの出来るノードとして扱うことが求められる。
このためには、人に対してプログラムから処理命令を送れる仕組みが必要だ。
 
そこで本論文では、人に対してプログラム上から処理命令を送り、その処理の結果を返り値として受け取ることを実現する一連のシステム Babascript を提案する。
...
- プログラムはコンピュータの動作を定義するためのものである。
    - 従来はコンピュータの画面の中がメインであった
    - 実世界の様々な要素もプログラマブルになってる
- 実世界の主な構成要素である人に対して、プログラムから命令は送れない
- もし、命令を送ることが出来れば
    - 人をコンピュータやセンサー等と同じ、処理を実行するノードとして扱うことが出来る
    - 実行する処理内容に応じて、人とコンピュータを、最適な組み合わせで動かすことが出来る
- これによって、コンピュータが得意なことをコンピュータにやらせ、人は人にしかできないことや人のほうが得意なことをやるといった、本来あるべき処理の切り分け方が実現する
    - このためには、人をプログラムに組み込めるような仕組みが必要である。

- そこで、本論文では、プログラムに人への処理命令を組み込むことのできるBabascriptプログラミングフレームワークを提案する。
Babascriptを使うことによって、従来では実現しなかったような処理を、人を用いて実現することができる。
